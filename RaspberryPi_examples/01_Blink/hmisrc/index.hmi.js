REX.HMI.init = function(){
    ...
    var controls = {
        ...
        title: 'User controls',
        rows: [
            {alias: 'green', desc: 'Green LED', cstring: 'blink_task.CNB_GREEN:YCN', type: 'DW'},
            {type: 'ES'}
        ]
    };
    ...
    var status = {
        ...
        rows: [
            {alias: 'greenLED', desc: 'Green LED', cstring: 'blink_task.RPI__GPIO23:value', type: 'DR', color_true: 'green'},
            {alias: 'yellowLED', desc: 'Yellow LED', cstring: 'blink_task.RPI__GPIO24:value', type: 'DR', color_true: 'yellow'},
            {alias: 'redLED', desc: 'Red LED', cstring: 'blink_task.RPI__GPIO25:value', type: 'DR', color_true: 'red'},
        ]
    };
    ...
    REX.HMI.setTitle('RPi - blink LED example');
