...
//double output(0) temperature; //measured temperature is published via output y0 of the REXLANG block
//double output(1) cold_junction_temperature; //reading of the internal cold-junction temperature is published via output y2 of the REXLANG block
long output(0) thermocouple_data; //reading of the thermocouple is published via output y1 of the REXLANG block
long output(1) cold_junction_data; //reading of the internal cold-junction temperature is published via output y2 of the REXLANG block
