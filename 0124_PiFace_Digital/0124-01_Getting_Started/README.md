...
This example contains source files of a demonstration project, which is a 
modification of the project from the Getting started manual for the Raspberry Pi 
platform.
