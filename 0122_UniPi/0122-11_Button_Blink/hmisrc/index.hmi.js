REX.HMI.init = function(){
    ...
    var controls = {
        ...
        rows: [
            ...
            {alias: 'rly3default', desc: 'Relay 3 default', cstring: 'buttonblink_task.CNB_RLY3_DEFAULT:YCN', type: 'DW'},
            {alias: 'pushbutton', desc: 'Push button', cstring: 'buttonblink_task.UNP__I01:value', type: 'DR', reverse_meaning: false, label_true: 'PRESSED', label_false: 'RELEASED'}
        ]
    };
    ...
    var status = {
        ...
        rows: [
            {alias: 'rly1', desc: 'Relay 1', cstring: 'buttonblink_task.UNP__RLY1:value', type: 'DR'},
            {alias: 'rly2', desc: 'Relay 2', cstring: 'buttonblink_task.UNP__RLY2:value', type: 'DR'},
            {alias: 'rly3', desc: 'Relay 3', cstring: 'buttonblink_task.UNP__RLY3:value', type: 'DR'},
            {type:'ES'}
        ]
    };
    ...
    REX.HMI.setTitle('UniPi v1.1 - blink example with button');
