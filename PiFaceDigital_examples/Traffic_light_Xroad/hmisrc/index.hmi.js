REX.HMI.init = function(){
    ...
    var controls = {
        ...
        name:'User controls',
        rows:[
            {name: 'Mode', cstring: 'Example_RPI_Xroad_task.CNB_AUTO:YCN', type: 'DW', true_label: 'AUTO', false_label: 'MAN'},
            {name: 'Main road', label: 'Main-road-GO', cstring: 'Example_RPI_Xroad_task.MP_MAIN:BSTATE', type: 'MP', disable_by: {alias: 'Mode', reverse_meaning: true}},
            {name: 'Side road', label: 'Side-road-GO', cstring: 'Example_RPI_Xroad_task.MP_SIDE:BSTATE', type: 'MP', disable_by: {alias: 'Mode', reverse_meaning: true}},
        ]
    };
    ...
    var lights_main = {
        ...
        name:'Main road',
        rows:[
            {name: 'Red', alias: 'red_lightM', cstring: 'Example_RPI_Xroad_task.RPI__PFO2:value', type: 'DR', true_color:'red'},
            {name: 'Yellow', alias: 'yellow_lightM', cstring: 'Example_RPI_Xroad_task.RPI__PFO1:value', type: 'DR', true_color:'yellow'},
            {name: 'Green', alias: 'green_lightM', cstring: 'Example_RPI_Xroad_task.RPI__PFO0:value', type: 'DR', true_color:'green'},
            {type:"ES"}
        ]
    };
    REX.WebBuDi.addSection(lights_main);

    var lights_side = {
        column:3,
        name:'Side road',
        rows:[
            {name: 'Red', alias: 'red_lightS', cstring: 'Example_RPI_Xroad_task.RPI__PFO7:value', type: 'DR', true_color:'red'},
            {name: 'Yellow', alias: 'yellow_lightS', cstring: 'Example_RPI_Xroad_task.RPI__PFO6:value', type: 'DR', true_color:'yellow'},
            {name: 'Green', alias: 'green_lightS', cstring: 'Example_RPI_Xroad_task.RPI__PFO5:value', type: 'DR', true_color:'green'},
            {type:"ES"}
        ]
    };
    REX.WebBuDi.addSection(lights_side);
    ...
    REX.WebBuDi.addSection({
        ...
        rows: [
            {type: 'LINK', desc:"WebWatch", label:"Task", target_url: 'Example_RPI_Xroad_task.html'}
        ]
    });
    ...
    REX.HMI.setTitle('Crossroad traffic lights for PiFace Digital');
