REX.HMI.init = function(){
    ...
    var controls = {
        ...
        title: 'User controls',
        rows: [
            {alias: 'rly1_write', desc: 'Relay 1', cstring: 'buttonblink_task.CNB_RELAY1:YCN', type: 'DW'},
            {alias: 'out3default', desc: 'Out3 default', cstring: 'buttonblink_task.CNB_OUT3_DEFAULT:YCN', type: 'DW'},
            {alias: 'pushbutton', desc: 'Push button', cstring: 'buttonblink_task.RPI__PFI0U:value', type: 'DR', reverse_meaning: true, label_true: 'PRESSED', label_false: 'RELEASED'}
        ]
    };
    ...
    var status = {
        ...
        rows: [
            {alias: 'rly1', desc: 'Relay 1', cstring: 'buttonblink_task.RPI__PFO1:value', type: 'DR'},
            {alias: 'out2', desc: 'Output 2', cstring: 'buttonblink_task.RPI__PFO2:value', type: 'DR'},
            {alias: 'out3', desc: 'Output 3', cstring: 'buttonblink_task.RPI__PFO3:value', type: 'DR'},
            {type:"ES"}
        ]
    };
    ...
    // REX.HMI.Graph.addTrend({cstring: 'task_name.TRND_name', labels: ['Signal 1','Signal 2','Signal 3','Signal 3']});
    ...
    REX.HMI.setTitle('PiFace Digital - blink example with button');
