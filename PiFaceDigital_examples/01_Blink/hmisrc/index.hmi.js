REX.HMI.init = function(){
    ...
    var status = {
        ...
        rows: [
            {alias: 'rly1', desc: 'Relay 1', cstring: 'blink_task.RPI__PFO1:value', type: 'DR'},
            {alias: 'out2', desc: 'Output 2', cstring: 'blink_task.RPI__PFO2:value', type: 'DR'},
            {alias: 'out3', desc: 'Output 3', cstring: 'blink_task.RPI__PFO3:value', type: 'DR'}
        ]
    };
    ...
    REX.HMI.setTitle('PiFace Digital - blink example');  
