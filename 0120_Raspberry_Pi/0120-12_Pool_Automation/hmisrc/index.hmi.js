REX.HMI.init = function(){
    ...
    var controls = {
        ...
        rows: [
            {type: 'ES'},
            {label: 'PUSH', desc: 'Filtration mode', alias:"F_MODE", cstring: 'pool_task.MP_BUTTON:BSTATE', type: 'MP'}            
        ]
    };
    ...
    var status = {
        ...
        rows: [
            {alias: 'lights', desc: 'Pool lights', cstring: 'pool_task.NOT_LIGHTS:U', type: 'DR', color_true: 'yellow'},
            {alias: 'pump', desc: 'Filtration pump', cstring: 'pool_task.NOT_PUMP:Y', type: 'DR', color_true: 'green', reverse_meaning: true, label_true: 'RUNNING', label_false: 'STOPPED'},
            {alias: 'filtmode', desc: 'Filtration mode', cstring: 'pool_task.RS_NOFILTER:Q', type: 'DR', color_true: 'red', label_true: 'DISABLED', label_false: 'SCHEDULED'}
        ]
    };
    ...
    REX.WebBuDi.addSection({
        ...
        rows: [
            {type: 'LINK', desc:"WebWatch", label:"Task", target_url: 'pool_task.html'}
        ]
    });
    ...
    REX.HMI.setTitle('RPi - Pool automation');
