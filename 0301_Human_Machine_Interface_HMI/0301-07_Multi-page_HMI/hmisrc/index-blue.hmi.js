REX.HMI.init = function(){
    ...
    var indicators = {
        ...
        rows:[
            {name: 'Constant', alias: 'constant', cstring: 'myproject_task.CNB:Y', type: 'DR', true_color:'blue'},
            {name: 'Slow', alias: 'slow', cstring: 'myproject_task.BIS_SLOW:Y', type: 'DR', true_color:'blue'},
            {name: 'Fast', alias: 'fast', cstring: 'myproject_task.BIS_FAST:Y', type: 'DR', true_color:'blue'}
        ]
    };
