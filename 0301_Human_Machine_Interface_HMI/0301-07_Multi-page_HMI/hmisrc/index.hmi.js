REX.HMI.init = function(){
    ...
    var indicators = {
        ...
        rows:[
            ...
            {name: 'Slow', alias: 'slow', cstring: 'myproject_task.BIS_SLOW:Y', type: 'DR', true_color:'green'},
            {name: 'Fast', alias: 'fast', cstring: 'myproject_task.BIS_FAST:Y', type: 'DR', true_color:'green'}
        ]
    };
